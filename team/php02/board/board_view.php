                        ...
                        <div class="view_box">
                            <div class="user_info not_user">
                                <div class="user_info_box">
                                    <a href="board_member_info.php?memberId=">
                                        <p><em><?= $boardInfo['boardAuthor'] ?></em>님의 게시글 더보기 ></p>
                                    </a>
                                </div>
                            </div>
                            <div class="view_info">
                                <div class="info_list">
                                    <div class="view_num boardRegtime"><em style="color: black;"><?= $boardRegTime ?></em></div>
                            ...
                            <li class="<?= $thisId ?>">
                                <a href=" board_view.php?boardId=<?= $board['boardId'] ?>&page=<?= $pageNumber ?>">
                                    <div class="board_info">
                                        ...
                                        <div class="board_date"><?= $totalBoardRegTime ?></div>
...
<script>
    ...
    function confirmAction(action, boardId) {
        if (confirm(action + '하시겠습니까?')) {
            if (<?= $memberId ?> === <?= $myMemberId ?>) {
                window.location.href = 'board_' + action + '.php?boardId=' + boardId;
            } else {
