        ...
        <main id="login">
            <div class="login__box">
                ...
                <div class="right">
                    ...
                    //데이터 조회
                    $sql = "SELECT myMemberId, youId, youEmail, youName, youPass, memberDelete FROM drinkMember WHERE youId = '$youId' AND youPass = '$youPass'";
                    ...
                    if ($result) {
                        ...
                        if ($count == 0) {
                            ...
                            $_SESSION['memberDelete'] = $memberInfo['memberDelete'];
