...
<?php
    ...
    // echo "<pre>";
    // var_dump($memberInfo['youImgFile']);
    // echo "</pre>";
                    ...
                    <div id="mypage_main" class="tab-content">
                        <div class="main_box">
                            ...
                            <div class="modify_box">
                                ...
                                <form action="profilemodifySave.php" name="board_writeSave" method="post" enctype="multipart/form-data" class="modify_img">
                                    <div>    
                                        ...
                                        <div class="modifytext_box">
                                            <div class="modify_text modify">
                                                <h3>닉네임 수정하기</h3>
                                                <input type="text" id="modifyProfile" name="modifyProfile" class="input_newnick" placeholder="새 닉네임을 입력하세요.">
                                            </div>
                                            <div class="modify_text">
                                                <h3>비밀번호 입력</h3>
                                                <input type="password" id="modifyPass" name="modifyPass" class="input_newnick" placeholder="비밀번호 입력">
                                            </div>
                                        </div>
                                        <div class="profile_modify01">
                                            <div>
                                                <button type="submit" id="ModifyCancle">취소</button>
                                            </div>
                                            <div>
